...
public class ROVER_31 extends Rover {
    ...
    public ROVER_31(String serverAddress) {
        // constructor
        System.out.println(rovername + " rover object constructed");
        rovername = "ROVER_31";
	...
	//        destinations.add(targetLocation);
	        ...
	        while (true) {
	            ...
	            //System.out.println("ROVER_31 equipment list results drive " + equipment.get(0));
	            System.out.println(rovername + " equipment list results " + equipment + "\n");
	
	
	            // ***** do a SCAN *****
	            //System.out.println("ROVER_31 sending SCAN request");
	            scanMap = this.doScan();
	...
	//                        com.markTileForGather(destination);
	            ...
	            line = in.readLine();
	            if (line == null) {
	                System.out.println(rovername + "ROVER_31 check connection to server");
	                line = "";
	            }
	            if (line.startsWith("LOC")) {
	                currentLoc = extractLocationFromString(line);
	            ...
	            //System.out.println("ROVER_31 currentLoc after recheck: " + currentLoc);
	            //System.out.println("ROVER_31 previousLoc: " + previousLoc);
	...
	//            }
	            //System.out.println("ROVER_31 stuck test " + stuck);
    ...
    protected void clearReadLineBuffer() throws IOException {
        while (in.ready()) {
            //System.out.println("ROVER_31 clearing readLine()");
    ...
    protected ArrayList<String> getEquipment() throws IOException {
        //System.out.println("ROVER_31 method getEquipment()");
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        ...
        //System.out.println("ROVER_31 incomming EQUIPMENT result - first readline: " + jsonEqListIn);
...
//                    break;
//                }
                //System.out.println("ROVER_31 incomming EQUIPMENT result: " + jsonEqListIn);
                jsonEqList.append(jsonEqListIn);
                jsonEqList.append("\n");
                //System.out.println("ROVER_31 doScan() bottom of while");
            }
        } else {
        ...
        //System.out.println("ROVER_31 returnList " + returnList);
    ...
    public ScanMap doScan() throws IOException {
        //System.out.println("ROVER_31 method doScan()");
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        out.println("SCAN");
        ...
        if (jsonScanMapIn.startsWith("SCAN")) {
            while (!(jsonScanMapIn = in.readLine()).equals("SCAN_END")) {
                //System.out.println("ROVER_31 incomming SCAN result: " + jsonScanMapIn);
        ...
        //System.out.println("ROVER_31 finished scan while");

        String jsonScanMapString = jsonScanMap.toString();
        // debug print json object to a file
        //new MyWriter( jsonScanMapString, 0);  //gives a strange result - prints the \n instead of newline character in the file

        //System.out.println("ROVER_31 convert from json back to ScanMap class");
